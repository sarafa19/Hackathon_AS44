        ...
        <div class="container-fluid h-custom">
            <div class="row d-flex justify-content-center align-items-center h-100">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    <form action="Traitement/trait_recup1.php" method="post">
                        ...
                        <h2 class="text-center my-5">Recuperation de mot de passe</h2>


                        <?php
                        if (isset($_SESSION['sms_recup1'])) {
                        ?>
                            <div class="alert alert-warning d-flex align-items-center" role="alert">
                                <i class="bi bi-exclamation-triangle-fill me-2"></i>
                                <div>
                                    <?php
                                    echo $_SESSION['sms_recup1'];
                                    unset($_SESSION['sms_recup1']);
                                    ?>
                                </div>
                            </div>
                        <?php
                        ...
                        <div data-mdb-input-init class="form-outline mb-4">
                            <label class="form-label" for="form3Example3" style="font-size: 22px;">Entrez votre adresse e-mail :</label>
